...
(function(window) {
    ...
    FForm.prototype._validade = function() {
        var fld = this.fields[this.current],
            input = fld.querySelectorAll('input[required]'),
            textfield = fld.querySelectorAll('textarea[required]'),
            selectfield = fld.querySelectorAll('select[required]'),
            error;
        ...
        if (input) {
            for (var z = 0; z < input.length; z++) {
                if (input[z].type === 'radio' || input[z].type === 'checkbox') {
                    var checked = 0;
                    [].slice.call(fld.querySelectorAll('input[type="' + input[z].type + '"]')).forEach(function(inp) {
                        if (inp.checked) {
                            ++checked;
                        }
                    });
        ...
        if (textfield) {
            for (var z = 0; z < textfield.length; z++) {
                // assuming here '' or '-1' only
                if (textfield[z].value === '' || textfield[z].value === '-1') {
                    error = 'NOVAL';
                }
            }
        }
        ...
        if (selectfield) {
            for (var z = 0; z < selectfield.length; z++) {
                if (selectfield[z].value === '') {
                    error = 'NOVAL';
                }
